...
class EspCamWidget(QtWidgets.QWidget):
    ...
    def populate_ui_ctrl(self):
        ...
        self.ctrl_layout.addRow("EI API key NOPE", self.ei_api)

        self.label_txt = QtWidgets.QLineEdit()
        self.ctrl_layout.addRow("Label NO!!!", self.label_txt)

        self.label_button = QtWidgets.QPushButton("Upload (DON't)")
    ...
    def grab_image(self):
        ...
        if result is not None:
            ...
            image_name = "./images/{:d}.jpg".format(int(time.time()*10))
